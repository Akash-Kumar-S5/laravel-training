...
<div class="flex-col w-full md:flex md:flex-row md:min-h-screen">
    <div @click.away="open = false"
        ...
        <nav :class="{'block': open, 'hidden': !open}" class="flex-grow px-4 pb-4 md:block md:pb-0 md:overflow-y-auto">
            <x-admin-link :href="route('post.index')" :active="request()->routeIs('post.index')">
                {{ __('All Posts') }}
            </x-admin-link>
            <x-admin-link :href="route('post.my-posts')" :active="request()->routeIs('post.my-posts')">
                {{ __('My Posts') }}
            </x-admin-link>
            <x-admin-link :href="route('post.create')" :active="request()->routeIs('post.create')">
                {{ __('Create Post') }}
            </x-admin-link>
