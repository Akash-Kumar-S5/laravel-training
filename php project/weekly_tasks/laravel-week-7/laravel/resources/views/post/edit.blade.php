                    ...
                    <form action="{{ route('post.update',$post) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-6">
                            ...
                            <textarea id="description" name="description"
                                      class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"
                                      placeholder="...." required>{{ $post->post_description }}</textarea>
                        ...
                        <div class="mb-6">
                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white" for="current-image">Current Image</label>
                            <div>
                                <img src="{{ asset('storage/' . $post->post_image) }}" id="current-image" alt="Current Image" class="img-fluid" width="200" height="150">
                            </div>
                            <x-input-error :messages="$errors->get('image')" class="mt-2" />
                        </div>
                        <button type="submit"
